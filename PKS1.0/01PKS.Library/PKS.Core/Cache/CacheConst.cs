...
namespace PKS.Core
{
    ...
    public static class CacheConst
    {
        ...
        /// <summary>授权区域</summary>
        public static string AuthenticationRegion { get; } = "PKS.Authentication";
        /// <summary>子系统区域</summary>
        public static string SubSystemRegion { get; } = "PKS.Cache.SubSystem";
        /// <summary>子系统URL键</summary>
        public static string SubSystemUrlsKey { get; } = "URLS";
        /// <summary>权限区域</summary>
        public static string PermissionRegion { get; } = "PKS.Cache.Permissions";
        /// <summary>角色权限键</summary>
        public static string RoleKey { get; } = "RolePermissions-";
        /// <summary>用户权限键</summary>
        public static string UserKey { get; } = "UserPermissions-";
