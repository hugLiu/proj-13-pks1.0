...
namespace PKS.Data
{
    ...
    public class EFDbContext : DbContext, IDbContext
    {
        ...
        protected IDbContextConfig Config { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            bool isOracleClient = DbProvider.IsOracleClient(this.Config.ConnectionName);
            ...
            where TEntity : class
        {
            ...
            {
                mapping.ToTable(entityType.Name.ToUpperInvariant(), config.SchemaName);
            }
        }
