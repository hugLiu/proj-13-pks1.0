(function (q) {
    ...
    $.getJSON("../Content/Scripts/contextMenu4WorkArea.json", function (result) {
        ctxConfig = result;
    });

    layerCon.setOpts(source, getStyleOfFeature, slyMap, "color", ctxConfig, function (feature, layer) {
